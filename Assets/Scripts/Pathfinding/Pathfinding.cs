...
public class Pathfinding
{
    ...
    public Pathfinding(Grid<PathNode> grid, PathfindingType pathfindingType)
    {
        Instance = this;
    ...
    public Pathfinding(Grid<PathNode> grid, List<PathNode> openList, List<PathNode> closedList, PathfindingType pathfindingType)
    {
        Instance = this;
        this.grid = grid;
    ...
    public void SetRoutsList(List<PathNode> openList, List<PathNode> closedList)
    {
        this.openList = openList;
        this.closedList = closedList;
    }
    ...
    private List<PathNode> GetNeighbourList(PathNode currentNode) {
        ...
        if (currentNode.x - 1 >= 0) {
            ...
            // Left Down
            if (pathfindingType == PathfindingType.Route8)
            {
